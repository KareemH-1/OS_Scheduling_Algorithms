...
function App() {
  ...
  function returnBackBtn (){
    return (
      <button onClick={() => changeMainContent(" ")}> ↩ Go Back</button>
    )
  }
  const members = [
      {
      ...
      <div>
        <div className="header">
          ...
          <div className="Algorithms-grid">
            <button onClick={() => changeMainContent('FCFS')}>First Come First Serve (FCFS)</button>
            <button onClick={() => changeMainContent('SJF-P')}>Shortest Job First Preemptive (SJF)</button>
            <button onClick={() => changeMainContent('SJF-NP')}>Shortest Job First Non-Preemptive (SJF)</button>
            <button onClick={() => changeMainContent('PS-P')}>Priority Scheduling Preemptive</button>
            <button onClick={() => changeMainContent('PS-NP')}>Priority Scheduling Non- Preemptive</button>
            <button onClick={() => changeMainContent('RR')}>Round Robin (RR)</button>
          </div>
            ...
            <div className="membersGrid">
                <div className="member">
                  <div className="info">
                      {members.map((member) =>{
                          return(
                            <div className="member-cont" key={member.id}>
